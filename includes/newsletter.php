        ...
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto bg-brand-cream rounded-3xl p-8 md:p-12 shadow-soft">
                ...
                <form id="newsletterForm" class="space-y-4" action="[FORM_ACTION_URL]" method="post">
                    ...
                    <p class="text-xs text-gray-500">Double opt-in recommandé si votre plateforme le permet. <a href="[LIEN_POLITIQUE_CONFIDENTIALITE]" class="underline hover:text-brand-purple">Politique de confidentialité</a></p>
                </form>
